...
import csv
import logging
import tablib  # La version para Python3 de tablib 0.10.0 presenta errores al instalarse con pio
...
# Hallar el rango de dias de una semana, indispensable para filtrar por semana
def week_range(date):
